export default {
  '#': { pattern: /\d/ },
  X: { pattern: /[0-9a-zA-ZÆØÅæøå]/ },
  S: { pattern: /[a-zA-ZÆØÅæøå]/ },
  A: { pattern: /[a-zA-ZÆØÅæøå]/, transform: v => v.toLocaleUpperCase() },
  a: { pattern: /[a-zA-ZÆØÅæøå]/, transform: v => v.toLocaleLowerCase() },
  '!': { escape: true }
};
